...
export default async function AdminLinkHubSocialsPage() {
    ...
    <div className="w-full py-8 md:py-12 min-h-screen text-right" dir="rtl">
      <div className="container mx-auto px-4 max-w-4xl space-y-8">
        ...
        <div className="space-y-1">
          <h1 className="text-2xl md:text-3xl font-extrabold text-white">إدارة روابط شبكات التواصل الاجتماعي</h1>
